...
<div class="ccm-block-page-list-wrapper">
    ...
    foreach ($pages as $page):
        ...
        $date = date("<p>j</p> M", strtotime($page->getCollectionDatePublic()));
        //Attribute name
        $downloadfile = $page->getAttribute('download_file');
        ...
        <div class="<?php echo $entryClasses?> col-md-4 col-sm-12">


        <?php if ($includeEntryText): ?>
            <div class="ccm-block-page-list-page-entry-text blog-list">
                ...
                <?php if (isset($includeDescription) && $includeDescription): ?>
                    ...
                    <div class="ordernow">
                    <!-- Download if file if accociated with -->
                    <?php if ($downloadfile) { ?>
                          <a href="<?php echo $downloadfile->getDownloadUrl() ?>"target="_blank">Download</a>
                    <?php } ?>
                      </div>
                <?php endif; ?>
